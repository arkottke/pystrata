.. pystrata documentation master file

pyStrata Documentation
======================

A Python library for 1D equivalent-linear site response analysis.
...
Install pyStrata with pip:

.. code-block:: bash

   $ python -m pip install pyStrata
