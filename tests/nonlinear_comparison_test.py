...
(generated by examples/example-21.ipynb) and verify that:
...
Run example-21.ipynb first to generate the reference data.
"""
...
def _build_profile() -> pystrata.site.Profile:
    """Reconstruct the three-layer profile used in example-21."""
