...
def load_ts():
    ...
    return pysra.motion.TimeSeriesMotion(
        fname, 'ChiChi.txt from DeepSoil v6.1',
        time_step, accels
    )
...
class Comparison:
    ...
    def setup_class(cls):
        ...
        cls.calc(
            load_ts(), cls.profile, cls.profile.location('outcrop', index=-1)
        )
...
class TestExample02LE(Comparison):
    ...
    profile = pysra.site.Profile([
        pysra.site.Layer(
            pysra.site.SoilType(
                'Soil', 20., mod_reduc=None, damping=0
            ),
            20, 500
        ),
        pysra.site.Layer(
            pysra.site.SoilType(
                'Rock', 25., mod_reduc=None, damping=0.02
            ),
            0, 760
        ),
    ])
...
class TestExample02EL(Comparison):
    ...
    ref_name = 'ds-example-2a-le'
    calc = pysra.propagation.EquivalentLinearCalculation()
    profile = pysra.site.Profile([
        pysra.site.Layer(
            pysra.site.SoilType(
                'Soil', 20., mod_reduc=None, damping=0
...
class TestExample04EL(Comparison):
    ...
    profile = pysra.site.Profile([
        pysra.site.Layer(
            pysra.site.SoilType(
                'Soil', 20., mod_reduc=None, damping=0.05
            ),
            20, 500
        ),
        pysra.site.Layer(
